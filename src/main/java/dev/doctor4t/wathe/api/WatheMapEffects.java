...
public class WatheMapEffects {
    ...
    public static final Identifier DISTANT_CABIN_ID = Wathe.id("distant_cabin");
    ...
    public static final MapEffect DISTANT_CABIN = registerMapEffect(DISTANT_CABIN_ID, new DistantCabinMapEffect(DISTANT_CABIN_ID));
